...
export default function NumberSystem() {
  return (
    <div className="p-6 max-w-4xl mx-auto bg-background text-foreground">
      ...
      <p className="mb-2 text-muted-foreground">The formal rule is: Dividend = Divisor × Quotient + Remainder</p>
      <p className="mb-2 text-muted-foreground">In our example: 17 = 5 × 3 + 2</p>
      ...
      <p className="mb-2 text-muted-foreground">Example: 5! = 5 × 4 × 3 × 2 × 1 = 120.</p>
      <p className="mb-2 text-muted-foreground">Example: 4! = 4 × 3 × 2 × 1 = 24.</p>
      <p className="text-muted-foreground">Special case: By definition, 0! = 1. This is a mathematical rule needed to make many other formulas in higher math work correctly.</p>
      ...
      <ul className="list-disc ml-6 space-y-2 text-muted-foreground">
        <li>
          ...
          <p className="text-sm text-muted-foreground">How to use: Just take the last number (n), multiply it by the next number (n+1), and divide by 2.</p>
        ...
        <li>
          ...
          <p className="text-sm text-muted-foreground">How to use: Plug the last number (n) into the formula.</p>
        ...
        <li>
          ...
          <p className="text-sm text-muted-foreground">Formula: Sum = [n(n+1)/2]²</p>
          <p className="text-sm text-muted-foreground">How to use: This is simply the square of the formula for the sum of the first 'n' numbers!</p>
      ...
      <ul className="list-disc ml-6 space-y-2 text-muted-foreground">
        <li>
          ...
          <p className="text-sm text-muted-foreground">Example: Find the sum of 1+3+5+...+33. First, find how many numbers are in this series. Here, n = 33. Number of terms x = (33+1)/2 = 17. This means there are 17 odd numbers from 1 to 33. Sum = x² = 17² = 289. ✨</p>
        </li>
        <li>
          ...
          <p className="text-sm text-muted-foreground">Example: Find the sum of 2+4+6+...+50. First, find how many numbers are in this series. Here, n = 50. Number of terms x = 50/2 = 25. This means there are 25 even numbers from 2 to 50. Sum = x(x+1) = 25×(25+1) = 25×26 = 650.</p>
        </li>
      </ul>
