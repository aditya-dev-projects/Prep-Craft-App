    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-foreground">DSA Learning Kit</h1>
                <p className="text-xs sm:text-sm text-muted-foreground">Master Data Structures & Algorithms</p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Choose Your Learning Path</h2>
        ...
        {/* Motivational Footer */}
        <div className="text-center p-6 sm:p-8 bg-gradient-accent rounded-xl shadow-xl">
