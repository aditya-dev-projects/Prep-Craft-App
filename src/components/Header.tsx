      ...
      <div className="container mx-auto px-4 sm:px-6 py-8">
        <div className="text-center space-y-6">
          <div className="flex items-center justify-center gap-3">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold">DSA Learning Kit For All</h1>
          </div>
          ...
          <div className="bg-black/20 rounded-lg p-4 sm:p-6 max-w-md mx-auto">
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="font-semibold text-sm sm:text-base">Total Progress</span>
              ...
              <div className="text-center">
                <span className="text-xl sm:text-2xl font-bold">{totalProgress.percentage}%</span>
                <span className="text-xs sm:text-sm ml-2">completed</span>
              </div>
            </div>
          </div>
